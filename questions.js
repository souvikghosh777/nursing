...
const examQuestions = {
    ...
    section6: [
        ...
        },
        {
            ...
            options: ["High BP when lying", "Drop in BP upon standing", "High BP when standing", "Normal BP"],
            options_bn: ["শুয়ে থাকলে উচ্চ BP", "দাঁড়ালে BP কমে যাওয়া", "দাঁড়ালে উচ্চ BP", "স্বাভাবিক BP"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Hemoglobin", "Creatinine and BUN", "Blood sugar", "Cholesterol"],
            options_bn: ["হিমোগ্লোবিন", "ক্রিয়েটিনিন এবং BUN", "রক্তের শর্করা", "কোলেস্টেরল"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Exercise heart", "Mobilize secretions", "Increase appetite", "Improve vision"],
            options_bn: ["হৃদয় ব্যায়াম", "নিঃসরণ সচল করা", "ক্ষুধা বৃদ্ধি", "দৃষ্টি উন্নত"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Dry skin", "Edema and crackles in lungs", "Decreased BP", "Dehydration"],
            options_bn: ["শুষ্ক ত্বক", "এডিমা এবং ফুসফুসে ক্র্যাকেল", "হ্রাস BP", "ডিহাইড্রেশন"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options_bn: ["ভিটামিন কে", "প্রোটামিন সালফেট", "নালক্সোন", "অ্যাট্রোপিন"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Measure pain", "Assess level of consciousness", "Check blood sugar", "Measure BP"],
            options_bn: ["ব্যথা পরিমাপ", "চেতনার স্তর মূল্যায়ন", "রক্তের শর্করা পরীক্ষা", "BP পরিমাপ"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Pain relief", "Airway and fluid resuscitation", "Antibiotics", "Surgery"],
            options_bn: ["ব্যথা উপশম", "বায়ুপথ এবং তরল পুনরুত্থান", "অ্যান্টিবায়োটিক", "অস্ত্রোপচার"],
            correct: 1,
            marks: 1
        },
        {
        ...
        },
        {
            ...
            options: ["Increase protein", "Dialysis and fluid management", "High potassium diet", "No treatment"],
            options_bn: ["প্রোটিন বৃদ্ধি", "ডায়ালাইসিস এবং তরল ব্যবস্থাপনা", "উচ্চ পটাসিয়াম খাদ্য", "কোন চিকিৎসা নেই"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Diabetes", "Hypocalcemia and airway obstruction", "Hypertension", "Infection only"],
            options_bn: ["ডায়াবেটিস", "হাইপোক্যালসেমিয়া এবং বায়ুপথ বাধা", "উচ্চ রক্তচাপ", "শুধুমাত্র সংক্রমণ"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Measure BP", "Prevent atelectasis", "Check heart rate", "Measure glucose"],
            options_bn: ["BP পরিমাপ", "অ্যাটেলেক্টাসিস প্রতিরোধ", "হৃদস্পন্দন পরীক্ষা", "গ্লুকোজ পরিমাপ"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["High BP", "Tachycardia and hypotension", "Fever", "Rash"],
            options_bn: ["উচ্চ BP", "ট্যাকিকার্ডিয়া এবং হাইপোটেনশন", "জ্বর", "ফুসকুড়ি"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Increase appetite", "Prevent nausea and vomiting", "Cure infection", "Lower BP"],
            options_bn: ["ক্ষুধা বৃদ্ধি", "বমি বমি ভাব এবং বমি প্রতিরোধ", "সংক্রমণ নিরাময়", "BP কমানো"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Spicy food", "Proton pump inhibitors and antibiotics", "High fat diet", "No treatment"],
            options_bn: ["মশলাদার খাবার", "প্রোটন পাম্প ইনহিবিটর এবং অ্যান্টিবায়োটিক", "উচ্চ চর্বি খাদ্য", "কোন চিকিৎসা নেই"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Increase infection", "Remove fluid and promote healing", "Cause pain", "Decoration"],
            options_bn: ["সংক্রমণ বৃদ্ধি", "তরল অপসারণ এবং নিরাময় প্রচার", "ব্যথা সৃষ্টি", "সাজসজ্জা"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Soft abdomen", "Rigid abdomen and severe pain", "Normal bowel sounds", "No symptoms"],
            options_bn: ["নরম পেট", "শক্ত পেট এবং গুরুতর ব্যথা", "স্বাভাবিক অন্ত্রের শব্দ", "কোন লক্ষণ নেই"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Increase BP", "Replace blood loss or treat anemia", "Cure infection", "Reduce pain"],
            options_bn: ["BP বৃদ্ধি", "রক্তক্ষয় প্রতিস্থাপন বা রক্তাল্পতার চিকিৎসা", "সংক্রমণ নিরাময়", "ব্যথা হ্রাস"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["50,000-100,000/μL", "150,000-400,000/μL", "500,000-600,000/μL", "10,000-50,000/μL"],
            options_bn: ["৫০,০০০-১০০,০০০/μL", "১৫০,০০০-৪০০,০০০/μL", "৫০০,০০০-৬০০,০০০/μL", "১০,০০০-৫০,০০০/μL"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Fashion", "Prevent DVT", "Increase swelling", "Cause pain"],
            options_bn: ["ফ্যাশন", "DVT প্রতিরোধ", "ফোলা বৃদ্ধি", "ব্যথা সৃষ্টি"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Fluid in lungs", "Fluid in abdomen", "Fluid in heart", "Fluid in brain"],
            options_bn: ["ফুসফুসে তরল", "পেটে তরল", "হৃদয়ে তরল", "মস্তিষ্কে তরল"],
            correct: 1,
            marks: 1
        }
    ],
    ...
    section10: [
        ...
        },
        {
            ...
            options: ["Asthma", "Dehydration from diarrhea", "Hypertension", "Diabetes"],
            options_bn: ["হাঁপানি", "ডায়রিয়া থেকে ডিহাইড্রেশন", "উচ্চ রক্তচাপ", "ডায়াবেটিস"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Agriculture", "Rural and urban health", "Urban areas only", "Education only"],
            options_bn: ["কৃষি", "গ্রামীণ এবং শহুরে স্বাস্থ্য", "শুধুমাত্র শহুরে এলাকা", "শুধুমাত্র শিক্ষা"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Annual Survey Health Advisor", "Accredited Social Health Activist", "Advanced System Health Agent", "All State Health Administrator"],
            options_bn: ["বার্ষিক সমীক্ষা স্বাস্থ্য উপদেষ্টা", "স্বীকৃত সামাজিক স্বাস্থ্য কর্মী", "উন্নত সিস্টেম স্বাস্থ্য এজেন্ট", "সমস্ত রাজ্য স্বাস্থ্য প্রশাসক"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Blood", "Airborne droplets", "Water", "Food"],
            options_bn: ["রক্ত", "বায়ুবাহিত ড্রপলেট", "জল", "খাদ্য"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Doctor On-call Treatment Service", "Direct Observed Treatment Short-course", "Disease Outbreak Treatment System", "Daily Oral Treatment Schedule"],
            options_bn: ["ডাক্তার অন-কল চিকিৎসা সেবা", "সরাসরি পর্যবেক্ষিত চিকিৎসা সংক্ষিপ্ত কোর্স", "রোগ প্রাদুর্ভাব চিকিৎসা সিস্টেম", "দৈনিক মৌখিক চিকিৎসা সময়সূচী"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Dengue", "Poliomyelitis", "Tuberculosis", "Malaria"],
            options_bn: ["ডেঙ্গু", "পোলিওমাইলাইটিস", "যক্ষ্মা", "ম্যালেরিয়া"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Cancer treatment", "Maternal and child health services", "Hospital care", "Surgery"],
            options_bn: ["ক্যান্সার চিকিৎসা", "মাতৃ ও শিশু স্বাস্থ্য সেবা", "হাসপাতাল যত্ন", "অস্ত্রোপচার"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Teenagers only", "Children 0-6 years", "Elderly only", "Adults only"],
            options_bn: ["শুধুমাত্র কিশোর", "০-৬ বছর বয়সী শিশু", "শুধুমাত্র বয়স্ক", "শুধুমাত্র প্রাপ্তবয়স্ক"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Hepatitis", "Malaria", "Cholera", "Typhoid"],
            options_bn: ["হেপাটাইটিস", "ম্যালেরিয়া", "কলেরা", "টাইফয়েড"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Diabetes", "Waterborne diseases", "Heart disease", "Cancer"],
            options_bn: ["ডায়াবেটিস", "জলবাহিত রোগ", "হৃদরোগ", "ক্যান্সার"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No one", "Children and pregnant women", "Adults only", "Elderly only"],
            options_bn: ["কেউ না", "শিশু এবং গর্ভবতী মহিলা", "শুধুমাত্র প্রাপ্তবয়স্ক", "শুধুমাত্র বয়স্ক"],
            correct: 1,
            marks: 1
        },
        {
        ...
        },
        {
            ...
            options: ["Agriculture", "Institutional delivery", "Child education", "Old age pension"],
            options_bn: ["কৃষি", "প্রাতিষ্ঠানিক প্রসব", "শিশু শিক্ষা", "বৃদ্ধাশ্রম পেনশন"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["River disposal", "Segregation and proper disposal", "Open dumping", "Burning openly"],
            options_bn: ["নদী নিষ্পত্তি", "পৃথকীকরণ এবং সঠিক নিষ্পত্তি", "খোলা ডাম্পিং", "খোলাখুলি পোড়ানো"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Air to humans", "Animals to humans", "Plants to humans", "Water to humans"],
            options_bn: ["বায়ু থেকে মানুষ", "প্রাণী থেকে মানুষ", "উদ্ভিদ থেকে মানুষ", "জল থেকে মানুষ"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Agriculture", "Clean India", "Education", "Employment"],
            options_bn: ["কৃষি", "পরিষ্কার ভারত", "শিক্ষা", "কর্মসংস্থান"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Doctor, nurse, patient", "Hospital, clinic, home", "Medicine, food, water", "Agent, host, environment"],
            options_bn: ["ডাক্তার, নার্স, রোগী", "হাসপাতাল, ক্লিনিক, বাড়ি", "ওষুধ, খাদ্য, জল", "এজেন্ট, হোস্ট, পরিবেশ"],
            correct: 3,
            marks: 1
        },
        {
            ...
            options: ["Animals are immune", "Most of population is immune", "One person is immune", "No one is immune"],
            options_bn: ["প্রাণী প্রতিরোধী", "জনসংখ্যার বেশিরভাগ প্রতিরোধী", "একজন ব্যক্তি প্রতিরোধী", "কেউ প্রতিরোধী নয়"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Anopheles mosquito", "Culex mosquito", "Housefly", "Aedes mosquito"],
            options_bn: ["অ্যানোফিলিস মশা", "কিউলেক্স মশা", "মাছি", "এডিস মশা"],
            correct: 3,
            marks: 1
        },
        {
            ...
            options: ["Formula feeding", "Mixed feeding", "Breastfeeding", "No feeding"],
            options_bn: ["ফর্মুলা ফিডিং", "মিশ্র খাওয়ানো", "বুকের দুধ খাওয়ানো", "কোন খাওয়ানো নেই"],
            correct: 2,
            marks: 1
        },
        {
            ...
            question: "The incubation period of measles is:",
            question_bn: "হামের ইনকিউবেশন পিরিয়ড হল:",
            options: ["1-2 months", "7-14 days", "1-2 days", "21-28 days"],
            options_bn: ["১-২ মাস", "৭-১৪ দিন", "১-২ দিন", "২১-২৮ দিন"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Genetics only", "Heredity only", "Age", "Contact, air, water, vector"],
            options_bn: ["শুধুমাত্র জিনগত", "শুধুমাত্র বংশগত", "বয়স", "যোগাযোগ, বায়ু, জল, বাহক"],
            correct: 3,
            marks: 1
        },
        {
            ...
            options: ["Hospital delays only", "Doctor delays", "Delays in decision, reaching facility, receiving care", "Nurse delays"],
            options_bn: ["শুধুমাত্র হাসপাতাল বিলম্ব", "ডাক্তার বিলম্ব", "সিদ্ধান্ত, সুবিধায় পৌঁছানো, যত্ন গ্রহণে বিলম্ব", "নার্স বিলম্ব"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["Rest", "Post-exposure prophylaxis vaccine", "Antibiotics", "Surgery"],
            options_bn: ["বিশ্রাম", "পোস্ট-এক্সপোজার প্রফিল্যাক্সিস টিকা", "অ্যান্টিবায়োটিক", "অস্ত্রোপচার"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Men only", "Elderly only", "Infants only", "Pregnant women and adolescents"],
            options_bn: ["শুধুমাত্র পুরুষ", "শুধুমাত্র বয়স্ক", "শুধুমাত্র শিশু", "গর্ভবতী মহিলা এবং কিশোর"],
            correct: 3,
            marks: 1
        },
        {
    ...
    section11: [
        ...
        },
        {
            ...
            options: ["Maternal diabetes", "Blood pressure", "Heart disease", "Fetal abnormalities"],
            options_bn: ["মাতৃ ডায়াবেটিস", "রক্তচাপ", "হৃদরোগ", "ভ্রূণের অস্বাভাবিকতা"],
            correct: 3,
            marks: 1
        },
        {
            ...
            options: ["Oxytocin", "Estrogen", "Progesterone", "Testosterone"],
            options_bn: ["অক্সিটোসিন", "ইস্ট্রোজেন", "প্রোজেস্টেরন", "টেস্টোস্টেরন"],
            correct: 0,
            marks: 1
        },
        {
            ...
            question: "Colostrum is rich in:",
            question_bn: "কোলোস্ট্রাম সমৃদ্ধ:",
            options: ["Fat", "Sugar", "Antibodies", "Salt"],
            options_bn: ["চর্বি", "চিনি", "অ্যান্টিবডি", "লবণ"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["Normal labor", "Normal delivery", "All cases", "Cephalopelvic disproportion"],
            options_bn: ["স্বাভাবিক প্রসব", "স্বাভাবিক ডেলিভারি", "সমস্ত ক্ষেত্রে", "সেফালোপেলভিক ডিসপ্রপোরশন"],
            correct: 3,
            marks: 1
        },
        {
            ...
            options_bn: ["ফ্যালোপিয়ান টিউব", "জরায়ু", "ডিম্বাশয়", "সার্ভিক্স"],
            correct: 0,
            marks: 1
        },
        {
            ...
            options: ["Fetal weight", "Maternal health", "Cervical readiness for labor", "Blood pressure"],
            options_bn: ["ভ্রূণের ওজন", "মাতৃ স্বাস্থ্য", "প্রসবের জন্য সার্ভিকাল প্রস্তুতি", "রক্তচাপ"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["Pregnancy period", "Labor period", "Pre-pregnancy period", "Postpartum period"],
            options_bn: ["গর্ভাবস্থার সময়কাল", "প্রসব সময়কাল", "প্রাক-গর্ভাবস্থার সময়কাল", "প্রসবোত্তর সময়কাল"],
            correct: 3,
            marks: 1
        },
        {
            ...
            options: ["45-55 years", "30-35 years", "40-45 years", "60-65 years"],
            options_bn: ["৪৫-৫৫ বছর", "৩০-৩৫ বছর", "৪০-৪৫ বছর", "৬০-৬৫ বছর"],
            correct: 0,
            marks: 1
        },
        {
            ...
            options: ["Day 7", "Day 21", "Day 14", "Day 28"],
            options_bn: ["দিন ৭", "দিন ২১", "দিন ১৪", "দিন ২৮"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["5-7 kg", "15-20 kg", "25-30 kg", "10-12 kg"],
            options_bn: ["৫-৭ কেজি", "১৫-২০ কেজি", "২৫-৩০ কেজি", "১০-১২ কেজি"],
            correct: 3,
            marks: 1
        },
        {
            ...
            options: ["False labor pains", "True labor pains", "Postpartum pains", "No pain"],
            options_bn: ["মিথ্যা প্রসব ব্যথা", "সত্যিকারের প্রসব ব্যথা", "প্রসবোত্তর ব্যথা", "কোন ব্যথা নেই"],
            correct: 0,
            marks: 1
        },
        {
            ...
            options: ["Blood test", "Urine test", "Pap smear", "X-ray"],
            options_bn: ["রক্ত পরীক্ষা", "প্রস্রাব পরীক্ষা", "প্যাপ স্মিয়ার", "এক্স-রে"],
            correct: 2,
            marks: 1
        },
        {
        ...
        },
        {
            ...
            options: ["Placental delivery", "Cervical dilation", "Baby delivery", "Recovery"],
            options_bn: ["প্ল্যাসেন্টাল প্রসব", "সার্ভিকাল প্রসারণ", "শিশুর প্রসব", "পুনরুদ্ধার"],
            correct: 0,
            marks: 1
        },
        {
            ...
            options: ["Maternal diabetes", "Hypertension", "Hemolytic disease of newborn", "Infection"],
            options_bn: ["মাতৃ ডায়াবেটিস", "উচ্চ রক্তচাপ", "নবজাতকের হেমোলিটিক রোগ", "সংক্রমণ"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["Incubator only", "Formula feeding", "Separation", "Skin-to-skin contact"],
            options_bn: ["শুধুমাত্র ইনকিউবেটর", "ফর্মুলা ফিডিং", "বিচ্ছেদ", "ত্বক থেকে ত্বক যোগাযোগ"],
            correct: 3,
            marks: 1
        },
        {
            ...
            options: ["Fetal position", "Maternal weight", "Blood pressure", "Heart rate"],
            options_bn: ["ভ্রূণের অবস্থান", "মাতৃ ওজন", "রক্তচাপ", "হৃদস্পন্দন"],
            correct: 0,
            marks: 1
        },
        {
            ...
            options: ["Second trimester", "Third trimester", "First trimester", "During labor"],
            options_bn: ["দ্বিতীয় ত্রৈমাসিক", "তৃতীয় ত্রৈমাসিক", "প্রথম ত্রৈমাসিক", "প্রসবের সময়"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["Symphysis pubis", "Xiphoid process", "Below umbilicus", "Umbilicus"],
            options_bn: ["সিম্ফিসিস পিউবিস", "জিফয়েড প্রক্রিয়া", "নাভির নিচে", "নাভি"],
            correct: 3,
            marks: 1
        },
        {
            ...
            options: ["Hemorrhage", "Infection", "Diabetes", "Cancer"],
            options_bn: ["রক্তক্ষরণ", "সংক্রমণ", "ডায়াবেটিস", "ক্যান্সার"],
            correct: 0,
            marks: 1
        },
        {
            ...
            options: ["HIV", "Tuberculosis", "Syphilis", "Malaria"],
            options_bn: ["এইচআইভি", "যক্ষ্মা", "সিফিলিস", "ম্যালেরিয়া"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["Immediately after birth", "1 week", "1 month", "24 hours of birth"],
            options_bn: ["জন্মের সাথে সাথে", "১ সপ্তাহ", "১ মাস", "জন্মের ২৪ ঘন্টা পরে"],
            correct: 3,
            marks: 1
        },
        {
            ...
            options: ["Infection", "Headache", "Diabetes", "Hypertension"],
            options_bn: ["সংক্রমণ", "মাথাব্যথা", "ডায়াবেটিস", "উচ্চ রক্তচাপ"],
            correct: 0,
            marks: 1
        },
        {
            ...
            options: ["First trimester", "Third trimester", "Second trimester", "Never safe"],
            options_bn: ["প্রথম ত্রৈমাসিক", "তৃতীয় ত্রৈমাসিক", "দ্বিতীয় ত্রৈমাসিক", "কখনও নিরাপদ নয়"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["Episiotomy", "Cesarean", "Forceps delivery", "Amniotomy"],
            options_bn: ["এপিসিওটমি", "সিজারিয়ান", "ফোর্সেপস ডেলিভারি", "অ্যামনিওটমি"],
            correct: 3,
            marks: 1
        }
    ],
    ...
    section12: [
        ...
        },
        {
            ...
            options: ["Degree only", "Salary only", "Professional development", "Promotion only"],
            options_bn: ["শুধুমাত্র ডিগ্রি", "শুধুমাত্র বেতন", "পেশাদার উন্নয়ন", "শুধুমাত্র পদোন্নতি"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["Personal opinion", "Traditional methods only", "Guesswork", "Using research findings in practice"],
            options_bn: ["ব্যক্তিগত মতামত", "শুধুমাত্র ঐতিহ্যগত পদ্ধতি", "অনুমান", "অনুশীলনে গবেষণা ফলাফল ব্যবহার"],
            correct: 3,
            marks: 1
        },
        {
            ...
            options: ["Assessment, diagnosis, planning, implementation, evaluation", "Only assessment", "Only treatment", "Only documentation"],
            options_bn: ["মূল্যায়ন, রোগ নির্ণয়, পরিকল্পনা, বাস্তবায়ন, মূল্যায়ন", "শুধুমাত্র মূল্যায়ন", "শুধুমাত্র চিকিৎসা", "শুধুমাত্র ডকুমেন্টেশন"],
            correct: 0,
            marks: 1
        },
        {
            ...
            options: ["Giving orders only", "Working alone", "Guiding and influencing team", "Avoiding responsibility"],
            options_bn: ["শুধুমাত্র আদেশ দেওয়া", "একা কাজ করা", "দলকে গাইড এবং প্রভাবিত করা", "দায়িত্ব এড়ানো"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["No monitoring", "Maintaining and improving care standards", "No standards", "Ignoring errors"],
            options_bn: ["কোন পর্যবেক্ষণ নেই", "যত্ন মান বজায় রাখা এবং উন্নত করা", "কোন মান নেই", "ত্রুটি উপেক্ষা করা"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Complicate things", "No benefit", "Improve patient care", "Waste time"],
            options_bn: ["জিনিস জটিল করা", "কোন সুবিধা নেই", "রোগীর যত্ন উন্নত করা", "সময় নষ্ট করা"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["No responsibility", "Assigning appropriate tasks to others", "Avoiding work", "Doing everything alone"],
            options_bn: ["কোন দায়িত্ব নেই", "অন্যদের উপযুক্ত কাজ বরাদ্দ করা", "কাজ এড়ানো", "সবকিছু একা করা"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["July 12", "May 12", "June 12", "August 12"],
            options_bn: ["১২ জুলাই", "১২ মে", "১২ জুন", "১২ আগস্ট"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No thinking", "Negative thinking", "Purposeful reasoning and decision making", "Criticizing others"],
            options_bn: ["কোন চিন্তা নেই", "নেতিবাচক চিন্তা", "উদ্দেশ্যমূলক যুক্তি এবং সিদ্ধান্ত গ্রহণ", "অন্যদের সমালোচনা করা"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["Avoiding duty", "Being responsible for actions", "Blaming others", "No responsibility"],
            options_bn: ["দায়িত্ব এড়ানো", "কর্মের জন্য দায়ী হওয়া", "অন্যদের দোষারোপ করা", "কোন দায়িত্ব নেই"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Optional", "Accurate and timely", "Incomplete", "Delayed"],
            options_bn: ["ঐচ্ছিক", "নির্ভুল এবং সময়মত", "অসম্পূর্ণ", "বিলম্বিত"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Individual work", "No coordination", "Collaborative care delivery", "Working alone"],
            options_bn: ["ব্যক্তিগত কাজ", "কোন সমন্বয় নেই", "সহযোগিতামূলক যত্ন প্রদান", "একা কাজ করা"],
            correct: 2,
            marks: 1
        },
        {
            ...
            options: ["No signature", "Full information and voluntary agreement", "No explanation", "Force"],
            options_bn: ["কোন স্বাক্ষর নেই", "সম্পূর্ণ তথ্য এবং স্বেচ্ছায় চুক্তি", "কোন ব্যাখ্যা নেই", "বল"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No diversity", "Respecting cultural differences", "Ignoring culture", "One culture only"],
            options_bn: ["কোন বৈচিত্র্য নেই", "সাংস্কৃতিক পার্থক্য সম্মান করা", "সংস্কৃতি উপেক্ষা করা", "শুধুমাত্র একটি সংস্কৃতি"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No involvement", "Supporting patient rights", "Ignoring patients", "Following orders blindly"],
            options_bn: ["কোন সম্পৃক্ততা নেই", "রোগীর অধিকার সমর্থন করা", "রোগীদের উপেক্ষা করা", "অন্ধভাবে আদেশ অনুসরণ"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Friendship only", "Maintaining therapeutic relationship", "Personal relationships", "No limits"],
            options_bn: ["শুধুমাত্র বন্ধুত্ব", "থেরাপিউটিক সম্পর্ক বজায় রাখা", "ব্যক্তিগত সম্পর্ক", "কোন সীমা নেই"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Optional", "Systematic review of care quality", "Waste of time", "Punishment"],
            options_bn: ["ঐচ্ছিক", "যত্ন মানের পদ্ধতিগত পর্যালোচনা", "সময় নষ্ট", "শাস্তি"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No preparation", "Planning and communication", "Resisting change", "Ignoring staff"],
            options_bn: ["কোন প্রস্তুতি নেই", "পরিকল্পনা এবং যোগাযোগ", "পরিবর্তন প্রতিরোধ", "কর্মীদের উপেক্ষা করা"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Avoiding computers", "Integration of technology in nursing", "No technology", "Paper only"],
            options_bn: ["কম্পিউটার এড়ানো", "নার্সিংয়ে প্রযুক্তির একীকরণ", "কোন প্রযুক্তি নেই", "শুধুমাত্র কাগজ"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Blame game", "Communication and problem-solving", "Avoiding conflict", "Ignoring issues"],
            options_bn: ["দোষ খেলা", "যোগাযোগ এবং সমস্যা সমাধান", "সংঘাত এড়ানো", "সমস্যা উপেক্ষা করা"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Random work", "Prioritizing and organizing tasks", "Wasting time", "No planning"],
            options_bn: ["এলোমেলো কাজ", "কাজের অগ্রাধিকার এবং সংগঠিত করা", "সময় নষ্ট করা", "কোন পরিকল্পনা নেই"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Management convenience", "Quality of care", "Cost only", "No reason"],
            options_bn: ["ব্যবস্থাপনা সুবিধা", "যত্নের মান", "শুধুমাত্র খরচ", "কোন কারণ নেই"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Doctors", "Nursing council and regulations", "Personal choice", "Hospital only"],
            options_bn: ["ডাক্তার", "নার্সিং কাউন্সিল এবং প্রবিধান", "ব্যক্তিগত পছন্দ", "শুধুমাত্র হাসপাতাল"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No training", "Experienced nurse guiding new nurse", "No guidance", "Working alone"],
            options_bn: ["কোন প্রশিক্ষণ নেই", "অভিজ্ঞ নার্স নতুন নার্স গাইড করছে", "কোন নির্দেশিকা নেই", "একা কাজ করা"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Regular breaks", "Chronic workplace stress", "Good work-life balance", "Adequate support"],
            options_bn: ["নিয়মিত বিরতি", "দীর্ঘস্থায়ী কর্মক্ষেত্র চাপ", "ভাল কাজ-জীবন ভারসাম্য", "পর্যাপ্ত সমর্থন"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No purpose", "Identifying system failures", "Blaming staff", "Punishment"],
            options_bn: ["কোন উদ্দেশ্য নেই", "সিস্টেম ব্যর্থতা সনাক্ত করা", "কর্মীদের দোষারোপ করা", "শাস্তি"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No reporting", "Open communication and reporting", "Hiding errors", "Blame culture"],
            options_bn: ["কোন রিপোর্টিং নেই", "খোলা যোগাযোগ এবং রিপোর্টিং", "ত্রুটি লুকানো", "দোষ সংস্কৃতি"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No interaction", "Professional guidance and support", "No benefit", "Criticism only"],
            options_bn: ["কোন মিথস্ক্রিয়া নেই", "পেশাদার নির্দেশিকা এবং সমর্থন", "কোন সুবিধা নেই", "শুধুমাত্র সমালোচনা"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Minimal care", "Quality and safety of care", "Poor care", "No standards"],
            options_bn: ["ন্যূনতম যত্ন", "যত্নের মান এবং নিরাপত্তা", "খারাপ যত্ন", "কোন মান নেই"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No improvement", "Learn from experiences", "Repeat mistakes", "Ignore feedback"],
            options_bn: ["কোন উন্নতি নেই", "অভিজ্ঞতা থেকে শিখুন", "ভুল পুনরাবৃত্তি", "প্রতিক্রিয়া উপেক্ষা করা"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Low quality", "Excellence in nursing care", "Poor nursing", "No standards"],
            options_bn: ["নিম্ন মান", "নার্সিং যত্নে উৎকর্ষতা", "খারাপ নার্সিং", "কোন মান নেই"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Individual work", "Healthcare team working together", "Working in isolation", "No communication"],
            options_bn: ["ব্যক্তিগত কাজ", "স্বাস্থ্যসেবা দল একসাথে কাজ করছে", "বিচ্ছিন্নভাবে কাজ করা", "কোন যোগাযোগ নেই"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No guidance", "Framework for practice", "No framework", "Confusion"],
            options_bn: ["কোন নির্দেশিকা নেই", "অনুশীলনের জন্য কাঠামো", "কোন কাঠামো নেই", "বিভ্রান্তি"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Avoiding responsibility", "Preparedness and rapid response", "No preparation", "Panic"],
            options_bn: ["দায়িত্ব এড়ানো", "প্রস্তুতি এবং দ্রুত প্রতিক্রিয়া", "কোন প্রস্তুতি নেই", "আতঙ্ক"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Happiness", "Emotional exhaustion from caring", "Energy gain", "No effect"],
            options_bn: ["সুখ", "যত্ন থেকে আবেগজনিত ক্লান্তি", "শক্তি লাভ", "কোন প্রভাব নেই"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No measures", "Hand hygiene and PPE", "No protection", "Ignoring infection control"],
            options_bn: ["কোন ব্যবস্থা নেই", "হাত স্বাস্থ্যবিধি এবং পিপিই", "কোন সুরক্ষা নেই", "সংক্রমণ নিয়ন্ত্রণ উপেক্ষা করা"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Chaos", "Standardized care plan", "Random care", "No plan"],
            options_bn: ["বিশৃঙ্খলা", "মানসম্মত যত্ন পরিকল্পনা", "এলোমেলো যত্ন", "কোন পরিকল্পনা নেই"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["No purpose", "Monitor patient progress", "Waste time", "Avoid patients"],
            options_bn: ["কোন উদ্দেশ্য নেই", "রোগীর অগ্রগতি পর্যবেক্ষণ", "সময় নষ্ট করা", "রোগীদের এড়ানো"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Cost only", "Patient preferences and needs", "Hospital convenience", "Staff convenience"],
            options_bn: ["শুধুমাত্র খরচ", "রোগীর পছন্দ এবং প্রয়োজন", "হাসপাতাল সুবিধা", "কর্মীদের সুবিধা"],
            correct: 1,
            marks: 1
        },
        {
            ...
            options: ["Time waste", "Essential for professional growth", "Not needed", "Optional"],
            options_bn: ["সময় নষ্ট", "পেশাদার বৃদ্ধির জন্য অপরিহার্য", "প্রয়োজন নেই", "ঐচ্ছিক"],
            correct: 1,
            marks: 1
        }
    ]
